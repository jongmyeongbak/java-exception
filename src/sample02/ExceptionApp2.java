...
public class ExceptionApp2 {
	...
	//	- 예외를 일괄처리하는 main 메서드에서 처리할 예외의 개수가 매우 많아진다.
	//////////////////////////////////////////////////////////////////
...
//	}
	...
	//////////////////////////////////////////////////////////////////
	// 예외전환하기를 사용한 경우
	//	- main 메서드에서 호출하는 메서드들이 Exception 예외를 발생시키도록
	//	  실제 발생한 예외객체는 catch 블록을 이용해 가로챘다.
	//	- throw 키워드를 이용하여 Exception 예외를 강제 발생시켰다.
	//	- main 메서드에서 호출하는 메서드들이 Exception 예외를 발생시키기 때문에
	//	  main 메서드에서 일괄 예외처리가 훨씬 쉬워진다.
	//////////////////////////////////////////////////////////////////
	public static void writeFile(String text) throws Exception {
		try {
			...
			throw new Exception("읽고 쓰기 오류 발생", e);
		}
	}
	...
	public static Date toDate(String text) throws Exception {
		try {
			...
			throw new Exception("날짜 변환 오류 발생", e);
		}
	}
